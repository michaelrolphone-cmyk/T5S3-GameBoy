...
`usb-xinput-gamepad` 0.1.0 driver for a `045e:028e` receiver. This receiver
...
map by SNES position: south/east/west/north become B/A/Y/X; Back becomes Select.
...
controller, and disconnect/error events clear held buttons.
